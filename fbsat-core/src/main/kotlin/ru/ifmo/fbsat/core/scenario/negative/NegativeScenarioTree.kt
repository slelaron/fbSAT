...
class NegativeScenarioTree(
    ...
    init {
        ...
        Node(element = auxScenarioElement, parent = null, -1, false)
    }
...
${
    ...
    fun isFinal(v: Int) = nodes[v - 1].isFinal
    ...
    fun addScenario(scenario: NegativeScenario) {
        ...
        addGenericScenario(
            ...
            newNode = { index, element, current ->
                Node(element, parent = current, height = index, isFinal = false).also { newNode ->
